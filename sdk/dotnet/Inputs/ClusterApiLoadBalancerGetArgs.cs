...
namespace Pulumi.Kops.Inputs
{
    ...
    public sealed class ClusterApiLoadBalancerGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("accessLog")]
        public Input<Inputs.ClusterApiLoadBalancerAccessLogGetArgs>? AccessLog { get; set; }
        ...
        [Input("subnets")]
        private InputList<Inputs.ClusterApiLoadBalancerSubnetGetArgs>? _subnets;
        public InputList<Inputs.ClusterApiLoadBalancerSubnetGetArgs> Subnets
        {
            get => _subnets ?? (_subnets = new InputList<Inputs.ClusterApiLoadBalancerSubnetGetArgs>());
            set => _subnets = value;
        }
        ...
        public ClusterApiLoadBalancerGetArgs()
        {
        }
        public static new ClusterApiLoadBalancerGetArgs Empty => new ClusterApiLoadBalancerGetArgs();
    }
}
