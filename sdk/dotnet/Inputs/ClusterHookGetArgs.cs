...
namespace Pulumi.Kops.Inputs
{
    ...
    public sealed class ClusterHookGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("befores")]
        ...
        [Input("execContainer")]
        public Input<Inputs.ClusterHookExecContainerGetArgs>? ExecContainer { get; set; }
        ...
        public ClusterHookGetArgs()
        {
        }
        public static new ClusterHookGetArgs Empty => new ClusterHookGetArgs();
    }
}
