...
namespace Pulumi.Kops
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Kops.version.txt");
    ...
    internal sealed class KopsResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public KopsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
